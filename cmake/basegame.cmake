...
if(BUILD_GAME_LIBRARIES)
    ...
    if(ANDROID)
        # Shipped in the APK, so it needs the prefix to be extracted at all
        # (see DLL_PREFIX in q_platform.h)
        set_target_properties(  ${CGAME_MODULE_BINARY_BASEGAME} PROPERTIES PREFIX ${ANDROID_APK_LIBRARY_PREFIX})
    endif()
    ...
    if(ANDROID)
        set_target_properties(  ${GAME_MODULE_BINARY_BASEGAME} PROPERTIES PREFIX ${ANDROID_APK_LIBRARY_PREFIX})
    endif()
